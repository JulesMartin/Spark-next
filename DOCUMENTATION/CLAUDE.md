...
Lien dashboard Supabase : https://supabase.com/dashboard (ouvrir le projet spark-next)
...
Utilisé uniquement pour `/api/candidature`. Envoie un email de notification à l'adresse définie dans `CONTACT_EMAIL` à chaque nouvelle candidature.
