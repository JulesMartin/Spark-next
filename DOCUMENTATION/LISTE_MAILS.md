...
| `contenu-dm` | 7             | Ressource Contenu DM      |
| `audit-dm`  | 8              | Ressource Audit DM        |
| `fable-dm`  | 9              | Ressource Fable DM        |
| `photo-dm`  | 10             | Ressource Photo DM        |
| `codex-dm`  | 11             | Ressource Codex DM        |
| `stack-dm`  | 12             | Ressource Stack DM        |
